    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* About */}
          <div>
            <h3 className="text-xl font-bold mb-4">EcoTransform</h3>
            <p className="text-gray-400 mb-4">
              Transforming waste into sustainable treasures, one piece at a time.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>Email: info@ecotransform.com</li>
              <li>Phone: +254708905136</li>
              <li>Address: Kitere Hills, Rongo</li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-gray-800 text-gray-400">
          <div className="flex justify-between items-center px-4">
            <p>© 2025 EcoTransform. All rights reserved.</p>
            <p>
              Developed and managed by{' '}
              <a 
                href="https://twitter.com/munyi_victor" 
                target="_blank" 
